...
2. 「Add domain」をクリックして以下のドメインを追加：
...
#### Vercelの動的ドメイン用（ワイルドカード）：
- `business-card-manager-*.vercel.app`
- または具体的に：
  - `business-card-manager-9ksaluzm2-yasuus-projects.vercel.app`
  - `business-card-manager-kvo1q0zlg-yasuus-projects.vercel.app`
  - その他のVercelデプロイドメイン

**注意**: Vercelは各デプロイで新しいURLを生成するため、定期的に新しいドメインを追加する必要があります。
